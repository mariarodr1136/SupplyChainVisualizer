...
**[supply-chain-visualizer.onrender.com](https://supply-chain-visualizer.onrender.com)** — no signup needed: click **Sign In for Free Demo** on the login page (credentials `guest` / `guest` are pre-filled).
